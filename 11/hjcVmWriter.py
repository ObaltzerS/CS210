...
class VmWriter(object):
    ...
    def WritePush(self, segment, index):
        ...
        """
        self._WriteCommand('push {} {}'.format(self._SegName(segment), index))
    ...
    def WritePop(self, segment, index):
        ...
        """
        self._WriteCommand('pop {} {}'.format(self._SegName(segment), index))
    ...
    def WriteArithmetic(self, command):
        ...
        """
        self._WriteCommand('{}'.format(self._OpName(command)))
    ...
    def WriteLabel(self, label):
        ...
        """
        self._WriteCommand('label {}'.format(label), False)
    ...
    def WriteGoto(self, label):
        ...
        """
        self._WriteCommand('goto {}'.format(label))
    ...
    def WriteIf(self, label):
        ...
        """
        self._WriteCommand('if-goto {}'.format(label))
    ...
    def WriteCall(self, name, nArgs):
        ...
        """
        self._WriteCommand('call {} {}'.format(name, nArgs))
    ...
    def WriteFunction(self, name, nLocals):
        ...
        """
        self.fnLineNumber = 0
        self._WriteCommand('function {} {}'.format(name, nLocals))
    ...
    def _WriteCommand(self, command, outputLineNumber=True):
        """
        Helper function to write a VM command.
        """
        self.outputFile.write(command)
        if self.debug and outputLineNumber:
            n = len(command)
            i = 8-n%8
            ...
            while n < 24:
                ...
                n += 8
            self.outputFile.write('// {}'.format(self.fnLineNumber))
            self.fnLineNumber += 1
